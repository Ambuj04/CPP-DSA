//construct tree by inroder and preorder 
//given inorder 1 6 8 7
//preorder 1 6 7 8 
//N = 4
...
class Solution {
  ...
  Node* solve(vector<int> &inorder, vector<int> &preorder,int &index,int inorderStart,int inorderEnd,int n){
    ...
    Node *buildTree(vector<int> &inorder, vector<int> &preorder) {
        ...
        Node* ans =   solve(inorder,preorder,preOrderIndex,inOrderStartIndex,inOrderEndIndex,n);
    return ans;
 ...
 createMapping(inorder,nodeToIndex,n);
        ...
        Node* ans =   solve(inorder,preorder,preOrderIndex,inOrderStartIndex,inOrderEndIndex,n,nodeToIndex);
    return ans;
